...
export const COURSES: Omit<Course, "lessonCount">[] = [
  ...
  },
  {
    ...
    numbering: "unit-lesson",
    title: "MEN 성인 회화",
    titleEn: "Men's Spoken Drills",
    kind: "audio-drill",
    description: "성인 남성 실전 비즈니스 및 일상 회화 트랙 (홍길동 트랙).",
    series: [{ slug: "am", title: "남성 트랙", prefix: "am" }],
  },
  {
    slug: "adults-w",
    tab: "women",
    ...
    numbering: "unit-lesson",
    title: "WOMEN 성인 회화",
    titleEn: "Women's Spoken Drills",
    kind: "audio-drill",
    description: "성인 여성 실전 비즈니스 및 일상 회화 트랙 (박수민 트랙).",
    series: [{ slug: "aw", title: "여성 트랙", prefix: "aw" }],
  },
  {
    slug: "adults",
    tab: "women",
